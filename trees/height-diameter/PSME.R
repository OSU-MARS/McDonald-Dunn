...
if (psmeOptions$fitHeightPrimary)
{
  ...
  psmeHeightFromDiameter$hossfeld = fit_gsl_nls("Hossfeld IV", height ~ 1.37 + (a1 + a1p * isPlantation) / (1 + (b1 + b1p * isPlantation) * dbh^(b2 + b2p * isPlantation)), psme2022, start = list(a1 = 75.4, a1p = -11.4, b1 = 462, b1p = -322, b2 = -1.54, b2p = 0.28))
  ...
  psmeHeightFromDiameter$sharmaPartonBal = fit_gsl_nls("Sharma-Parton BA+L", height ~ 1.37 + (a1 + a1p * isPlantation)*topHeight^(b1 + b1p * isPlantation) * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3 * dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 6, a1p = 13, b1 = 0.6, b1p = -0.33, b2 = -0.025, b3 = 0.0, b4 = 1.53, b4p = -0.15))
  ...
  psmeHeightFromDiameter$sharmaPartonBalPhysioRelDbh = fit_gsl_nls("Sharma-Parton BA+L RelDbh physio", height ~ 1.37 + (a1 + a1p * isPlantation + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * terrainRoughness + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^b1 * (1 - exp((b2 + b2p * isPlantation)*(tph/(standBasalAreaPerHectare + basalAreaLarger))^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 22, a1p = -7.6, a4 = -0.0020, a5 = -0.03, a6 = 0.14, a7 = 0.14, a8 = 0.06, a9 = -0.35, a9p = 0.79, b1 = 0.28, b2 = -0.021, b2p = -0.026, b3 = 0.02, b3p = -0.17, b4 = 1.53, b4p = -0.40))
  psmeHeightFromDiameter$sharmaPartonBalRelDbh = fit_gsl_nls("Sharma-Parton BA+L RelDbh", height ~ 1.37 + (a1 + a1p * isPlantation + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^(b1 + b1p * isPlantation) * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3 * dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 4.2, a1p = 14.5, a9 = 0.16, a9p = 0.27, b1 = 0.63, b1p = -0.43, b2 = -0.025, b3 = -0.09, b4 = 1.73, b4p = -0.66))
  ...
  psmeHeightFromDiameter$sharmaPartonRelDbh = fit_gsl_nls("Sharma-Parton RelDbh", height ~ 1.37 + (a1 + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation) * dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 13.3, a9 = -0.2, a9p = 0.73, b1 = 0.40, b1p = -0.12, b2 = -0.020, b2p = -0.0233, b3 = 0.032, b3p = -0.20, b4 = 1.5, b4p = -0.39))
  psmeHeightFromDiameter$sharmaPartonRelDbhPhysio = fit_gsl_nls("Sharma-Parton RelDbh physio", height ~ 1.37 + (a1 + a4 * elevation + a5 * slope + a7 * cos(3.14159/180 * aspect) + a8 * terrainRoughness + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^b1 * (1 - exp(b2*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 15.5, a4 = -0.0016, a5 = -0.028, a7 = 0.17, a8 = 0.06, a9 = 0.48, a9p = -0.3, b1 = 0.33, b2 = -0.027, b3 = -0.043, b3p = -0.074, b4 = 1.52, b4p = -0.55))
  psmeHeightFromDiameter$sharmaZhang = fit_gsl_nls("Sharma-Zhang", height ~ 1.37 + (a1 + a1p * isPlantation)*standBasalAreaPerHectare^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*tph^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 54, a1p = -33, b1 = 0.05, b1p = 0.2, b2 = -0.03, b2p = -0.05, b3 = -0.04, b3p = -0.16, b4 = 1.56, b4p = -0.48))
  ...
  if (psmeOptions$fitPhysioGams)
  {
    ...
    save(file = "trees/height-diameter/data/PSME height primary GAMs.Rdata", psmeHeightFromDiameterGamBalPhysio, psmeHeightFromDiameterGamBalPhysioRelDbh, psmeHeightFromDiameterGamPhysio, psmeHeightFromDiameterGamRelDbhPhysio)
    ...
    load("trees/height-diameter/data/PSME height primary GAMs.Rdata")
  ...
  save(file = "trees/height-diameter/data/PSME height.rdata", psmeHeightFromDiameter)
}
...
if (psmeOptions$fitHeightMixed)
{
  ...
  psmeHeightFromDiameterMixed$hossfeld = fit_nlme("Hossfeld IV", height ~ 1.37 + (a1 + a1p * isPlantation + a1r) / (1 + (b1 + b1p * isPlantation) * dbh^(b2 + b2p * isPlantation)), psme2022, 
  ...
  psmeHeightFromDiameterMixed$sharmaParton = fit_nlme("Sharma-Parton", height ~ 1.37 + (a1 + a1r)*topHeight^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, 
  ...
  psmeHeightFromDiameterMixed$sharmaPartonBal = fit_nlme("Sharma-Parton BA+L", height ~ 1.37 + (a1 + a1p * isPlantation + a1r)*topHeight^(b1 + b1p * isPlantation) * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3*dbh))^(b4 + b4p * isPlantation), psme2022, 
  ...
  psmeHeightFromDiameterMixed$sharmaPartonPhysio = fit_nlme("Sharma-Parton physio", height ~ 1.37 + (a1 + a1r + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * terrainRoughness)*topHeight^b1 * (1 - exp(b2*(tph/standBasalAreaPerHectare)^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, 
  ...
  psmeHeightFromDiameterMixed$sharmaZhang = fit_nlme("Sharma-Zhang", height ~ 1.37 + (a1 + a1p * isPlantation + a1r)*standBasalAreaPerHectare^(b1 + b1p * isPlantation)*(1 - exp((b2 + b2p * isPlantation)*tph^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, 
  ...
  psmeHeightFromDiameterMixed$sharmaZhangBal = fit_nlme("Sharma-Zhang BA+L", height ~ 1.37 + (a1 + a1r + (a2 + a2p * isPlantation) * basalAreaLarger + (a3 + a3p * isPlantation) * standBasalAreaPerHectare)*standBasalAreaPerHectare^b1 * (1 - exp(b2*tph^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, 
  ...
  save(file = "trees/height-diameter/data/PSME height mixed.Rdata", psmeHeightFromDiameterMixed)
}
...
if (psmeOptions$fitDbhPrimary)
{
  ...
  if (psmeOptions$fitDbhGslNlsAndGams)
  {
    ...
    psmeDiameterFromHeight$sharmaParton = fit_gsl_nls("modified Sharma-Parton", dbh ~ a1*(height - 1.37)^(b1 + b1p * isPlantation)*(exp(b2*(tph/topHeight)^(b3 + b3p * isPlantation)*(height - 1.37)) - 1)^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 9, b1 = 0.4, b1p = -0.14, b2 = 0.04, b3 = -0.06, b3p = 0.11, b4 = 0.3, b4p = 0.13), control = nlmeControl())
...
if (psmeOptions$fitDbhMixed)
{
  ...
  psmeDiameterFromHeightMixed$sharmaParton = fit_nlme("modified Sharma-Parton", dbh ~ (a1 + a1r + a1r) * (height - 1.37)^(b1 + b1p * isPlantation)*(exp(b2*(tph/topHeight)^(b3 + b3p * isPlantation)*(height - 1.37)) - 1)^(b4 + b4p * isPlantation), psme2022, 
    ...
    psmeOptions$fitDbhPrimary & psmeOptions$fitDbhMixed & psmeOptions$fitDbhNlrobAndFixedWeight)
{
  ...
  if (exists("psmeHeightFromDiameter") == FALSE) { load("trees/height-diameter/data/PSME height primary.rdata") }
  if (exists("psmeHeightFromDiameterMixed") == FALSE) { load("trees/height-diameter/data/PSME height mixed.Rdata") }
...
if (psmeOptions$fitHeightPrimary & psmeOptions$fitHeightNlrobAndFixedWeight & psmeOptions$fitDbhPrimary & psmeOptions$fitDbhNlrobAndFixedWeight)
{
  ...
  psmeHeightFromDiameterPreferred$sharmaPartonBalPhysioRelDbh = fit_gsl_nls("Sharma-Parton BA+L RelDbh physio", height ~ 1.37 + (a1 + a1p * isPlantation + a4 * elevation + a5 * slope + a6 * sin(3.14159/180 * aspect) + a7 * cos(3.14159/180 * aspect) + a8 * terrainRoughness + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^b1 * (1 - exp((b2 + b2p * isPlantation)*(tph/(standBasalAreaPerHectare + basalAreaLarger))^(b3 + b3p * isPlantation)*dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 22, a1p = -7.6, a4 = -0.0020, a5 = -0.03, a6 = 0.14, a7 = 0.14, a8 = 0.06, a9 = -0.35, a9p = 0.79, b1 = 0.28, b2 = -0.021, b2p = -0.026, b3 = 0.02, b3p = -0.17, b4 = 1.53, b4p = -0.40), folds = 1, repetitions = 1)
  psmeHeightFromDiameterPreferred$sharmaPartonBalRelDbh = fit_gsl_nls("Sharma-Parton BA+L RelDbh", height ~ 1.37 + (a1 + a1p * isPlantation + (a9 + a9p * isPlantation) * relativeDiameter)*topHeight^(b1 + b1p * isPlantation) * (1 - exp(b2*(tph/(standBasalAreaPerHectare + basalAreaLarger))^b3 * dbh))^(b4 + b4p * isPlantation), psme2022, start = list(a1 = 4.2, a1p = 14.5, a9 = 0.16, a9p = 0.27, b1 = 0.63, b1p = -0.43, b2 = -0.025, b3 = -0.09, b4 = 1.73, b4p = -0.66), folds = 1, repetitions = 1)
...
{
  psmeHeightGam = fit_gam("REML GAM", height ~ s(dbh, bs = "ts", by = as.factor(isPlantation), k = 11) + 
                          ...
                          data = psme2022, folds = 1, repetitions = 1)
  ...
  psmeDbhGam = fit_gam("REML GAM", dbh ~ s(height, bs = "ts", by = as.factor(isPlantation), k = 10) +
